...
<div align="center">
    <a href="https://emberjs.com">Ember 4.0+</a> Modifiers for accessing the component's element(s), force-setting its ID Attribute, and reacting to Argument changes
</div>
<div align="center">
...
This package contains an [Ember](https://emberjs.com) addon implementing modifiers that allow Emberistas to access HTML Element in the Component's DOM, setting its
ID Attribute, and for reacting to changes in the Arguments passed to it
...
| Publish Status | ![node-current](https://img.shields.io/node/v/@twyr/ember-component-modifiers) ![npm bundle size](https://badgen.net/bundlephobia/min/@twyr/ember-component-modifiers) ![npm](https://img.shields.io/npm/dy/@twyr/ember-component-modifiers)                                                                                                                                                                                                                                                                                                                                                                                                                                           |
