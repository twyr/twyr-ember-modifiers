...
<div align="center">
    <a href="https://emberjs.com">Ember 4.0+</a> Modifiers for managing a Component's CSS Styles
</div>
<div align="center">
...
This package contains an [Ember](https://emberjs.com) addon implementing modifiers that allow Emberistas to set the Component's
CSS Styles, managing the CSS Classes applied to it's HTML Elements, and watching for changes in the Computed Styles
...
| Publish Status | ![node-current](https://img.shields.io/node/v/@twyr/ember-css-modifiers) ![npm bundle size](https://badgen.net/bundlephobia/min/@twyr/ember-css-modifiers) ![npm](https://img.shields.io/npm/dy/@twyr/ember-css-modifiers)                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
